...
import org.example.bingowebflux.domain.exception.ErrorFieldResponse;
...
import static org.example.bingowebflux.domain.constant.ErrorMessages.GENERIC_ERROR;
...
public class CustomExceptionHandler {
  ...
  public Mono<ResponseEntity<ExceptionResponse>> handlerException (final Exception ex) {
    return Mono.just(GENERIC_ERROR)
  ...
  private String getMessage(String error) {
    return messageSource.getMessage(error, null, new Locale("pt", "BR"));
  }
